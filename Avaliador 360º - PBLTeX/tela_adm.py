...
def fun_adm_alunos(): #Criação da tela de consulta da lista de alunos
    ...
    return sg.Window('ALUNOS', layout=layout_adm_alunos, margins=(10, 10), finalize=True)
...
def fun_adm_times(): #Criação da tela de consulta da lista de times
    ...
    return sg.Window('TIMES', layout=layout_adm_alunos, margins=(10, 10), finalize=True)
...
def fun_adm_notas(): #Criação da tela de consulta das notas 
    ...
    return sg.Window('NOTAS', layout=layout_adm_alunos, margins=(10, 10), finalize=True)

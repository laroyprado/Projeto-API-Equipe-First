...
class First():
    ...
    def fun_notas():
        ...
        layout_notas = [
            ...
            [sg.Text('Matrícula'), sg.Input(key='-MATRICULA-', size=(7, 1), readonly=True)],
            [sg.Input(size=(5, 1), readonly=True, key='-INPM1-'), sg.ProgressBar(50, orientation='h', size=(20, 20), border_width=1, key='-BARM1-')],
            [sg.Input(size=(5, 1), readonly=True, key='-INPM2-'), sg.ProgressBar(50, orientation='h', size=(20, 20), border_width=1, key='-BARM2-')],
            [sg.Input(size=(5, 1), readonly=True, key='-INPM3-'), sg.ProgressBar(50, orientation='h', size=(20, 20), border_width=1, key='-BARM3-')],
            [sg.Input(size=(5, 1), readonly=True, key='-INPM4-'), sg.ProgressBar(50, orientation='h', size=(20, 20), border_width=1, key='-BARM4-')],
            [sg.Input(size=(5, 1), readonly=True, key='-INPM5-'), sg.ProgressBar(50, orientation='h', size=(20, 20), border_width=1, key='-BARM5-')],
            [sg.Button('Retornar', expand_x=True, key='-BACK-')],
        ]
